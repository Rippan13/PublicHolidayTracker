...
const HeaderNavBar = () => {
  ...
  return (
    <Disclosure as="nav" className="bg-[#181c87] w-full">
      <div className="mx-auto px-2 sm:px-6 lg:px-8 w-full">
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="flex shrink-0 items-center">
            <h1 className="text-white font-bold">Public Holidays Tracker</h1>
          </div>
                  ...
                  <a
                    ...
                    className={classNames(
                      active === item.name
                        ...
                        : "text-white hover:bg-gray-400 hover:text-black cursor-pointer",
